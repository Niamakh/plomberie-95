  ...
  return (
    <article className="flex-1 min-w-0">
      <section>
        ...
        <ArticleFigure src="/images/articles/eau-calcaire-plomberie.svg" alt="Dépôts de calcaire blanc sur une canalisation et un robinet de salle de bain entartré" caption="L'entartrage se forme là où l'eau chauffe et stagne" priority />
      </section>
